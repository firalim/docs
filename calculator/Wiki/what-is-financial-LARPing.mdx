...
<Info>LARP stands for Live Action Role Play, where participants act out roles in a fictional setting. <Icon icon="info" /></Info>
...
<CardGroup cols={3}>
  <Card title="⚔️ Medieval Combat" color="#8b4513">Foam swords and chainmail</Card>
  <Card title="🧙‍♂️ Magic Systems" color="#4b0082">Spell components and incantations</Card>
  <Card title="🏰 Fantasy Worlds" color="#228b22">Kingdoms and quests</Card>
</CardGroup>
...
<Tabs>
  <Tab title="🎭 Pure LARP" icon="mask">
    Complete fiction<br />Zero backing
  </Tab>
  <Tab title="🎯 Strategic LARP" icon="target">
    Vision + hustle<br />Building toward reality
  </Tab>
  <Tab title="✅ Authentic Success" icon="check-circle">
    Real results<br />Proven track record
  </Tab>
</Tabs>

**Pro Tip**: The most successful Financial LARPers eventually transition from pure performance to strategic building, using their audience as validation and funding source.
</Frame>
...
<Frame>
<AccordionGroup>
  <Accordion title="Reddit Trader" icon="trending-up">
    ...
    *"HODL to the moon! 🚀🚀🚀 This $50 gain is just the beginning!"*
  </Accordion>
  <Accordion title="Pitch Deck Samurai" icon="briefcase">
    ...
    *"Disrupting the disruption of disruptive solutions. Stealth mode. 🥷"*
  </Accordion>
  <Accordion title="Dropshipping Sensei" icon="dollar-sign">
    ...
    *"I made $10K last month while you slept. Link in bio for my secrets! 💰"*
  </Accordion>
  <Accordion title="Fake VC Oracle" icon="lightbulb">
    ...
    *"At [Fake] Ventures, we back category-defining companies. Currently deploying capital. 📧"*
  </Accordion>
  <Accordion title="AI Buildbro" icon="cpu">
    ...
    *"Just shipped an AI that predicts AI predictions. Open source soon! ⚡"*
  </Accordion>
  <Accordion title="LinkedIn Thought Leader" icon="bar-chart">
    ...
    *"Disruption isn't just a strategy—it's a mindset. Agree? 🤔 #Leadership"*
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion title="Choose Your LARP Archetype" icon="star">
